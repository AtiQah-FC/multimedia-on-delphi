...
begin
	...
	Form4.WaveStream.Write(buffer^, length);
...
procedure TForm4.StartRecording;
begin
...
(* Stop recording *)
procedure TForm4.StopRecording;
var
	i: integer;
begin
...
procedure TForm4.bRecordClick(Sender: TObject);
begin
...
procedure TForm4.bPlayClick(Sender: TObject);
begin
...
procedure TForm4.UpdateInputInfo;
var
	i: DWord;
	level: Single;
begin
...
procedure TForm4.bSaveClick(Sender: TObject);
begin
...
procedure TForm4.PosTimerTimer(Sender: TObject);
begin
